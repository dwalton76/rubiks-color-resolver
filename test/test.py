...
test_cases = (
    ...
    ('4x4x4 random 02',    'test-data/4x4x4-random-02.txt',    'FULLUFBBFRRLLLLRDUUDDFLLFBLLBBDFDDDFBDDRRUUDBFFLDRRUDLLUUBFBRFDUULUBRRBLRRFUBFBRFBRRFUUBFDDBLRDU'),
    ('4x4x4 random 03',    'test-data/4x4x4-random-03.txt',    'DRDBBBRFBBDFLDUURRRDDUUBLFRRUFUUFLFFUUFRURLFURRRLBBBDBLDFLDLDLDLFLLDUUBFDDDBBLBBLFURUFLLUFRRFBDR'),
    ('4x4x4 random 04',    'test-data/4x4x4-random-04.txt',    'LBBDDBBRUDRDUFFBLFURUFLLUFRRFBDRRRRDDUUBLFRRUFUUBDLLBLDDBBLLLDFDFLFFUUFRURLFURRRFLLDUUBFDDDBBLBB'),
    ...
    ('6x6x6 random 01',    'test-data/6x6x6-random-01.txt',    'FBBDBRDDDURRLUDDURBUDDDLDFDDBFBBBURRBUDDBUUDFFFLRLFFLBFBRLLFDRRRUDLLBRFFRULBDDBUBFLRULLRFDLLBFBLFBFFFLBURBDDUBFURFFBDDBFDDUUUDDUUUUBUFUDDRDLUUFURBUDFURDLBLRUBLBFLULRBFFLULBRULRFFLLFDLRLDBURRLFLRRLRRRRFBRFLRBBLULDRFUB'),
)
