...
test_cases = (
    ...
    # ('6x6x6 random 02',    'test-data/6x6x6-random-02.txt',    'TBD'),
    ('6x6x6 random 03',    'test-data/6x6x6-random-03.txt',    'DDDDDLDUUUULUUUUUFFUUUUUUUUUUBRFFUFFLULUUBLLLLLFRLLLLBDLLLLLBLLLLFBFBDDRFURRDURBBBBFDBBBBBFBBBBRLBBBBUURUDDRLFBBLDRDDDDLFDDDDRUDDDDFRDDDDFUDDLRFLBRDLURRRRRDFRRRRBURRRRRBRRRRBRBBLUBDRLLBFUFFFFBLFFFFUFFFFFLRFFFFLDUBRLB'),
)
