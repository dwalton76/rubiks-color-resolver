...
test_cases = (
    ...
    ('5x5x5 random 03',    'test-data/5x5x5-random-03.txt',    'DRRFBFUUUBLUUURFUUULFUDFRUBURLLRRRDLRRRUBRRRLBDULDLRFRBUFFFUUFFFFRFFFURBBDDFDLFLRDDDBBDDDFDDDDBRDBFFFUDDUFLLLLDLLLBULLLDDLDUUURFBRRBBBLLBBBRFBBBBLURLB'),
